...
export const workflowStages: WorkflowStage[] = [
  ...
  },
  {
    ...
    label: "Gemini Gap",
    description: "Gemini가 요청 의도와 근거를 보고 상품화에 부족한 정보를 판단합니다.",
    agentName: "DataGapProfilerAgent",
    stepType: "data_gap_profile",
  },
  {
  ...
  {
    key: "tourapi_detail_planning",
    label: "Detail Planner",
    description: "Gemini가 KorService2 상세/이미지 보강 호출만 짧게 계획합니다.",
    agentName: "TourApiDetailPlannerAgent",
    stepType: "tourapi_detail_planning",
  },
  {
    key: "visual_data_planning",
    label: "Visual Planner",
    description: "Gemini가 관광사진/공모전 사진 API 후보를 보류 또는 향후 연결로 분리합니다.",
    agentName: "VisualDataPlannerAgent",
    stepType: "visual_data_planning",
  },
  {
    key: "route_signal_planning",
    label: "Route Planner",
    description: "Gemini가 두루누비, 연관 장소, 수요/혼잡 신호 후보를 분리합니다.",
    agentName: "RouteSignalPlannerAgent",
    stepType: "route_signal_planning",
  },
  {
  ...
  },
  {
    key: "data_enrichment",
    label: "Data Calls",
    description: "계획된 보강 호출만 실행하고, 보류/실패 사유를 기록합니다.",
    agentName: "EnrichmentExecutor",
    stepType: "data_enrichment",
  },
  {
    key: "evidence_fusion",
    label: "Gemini Fusion",
    description: "Gemini가 claim 가능 근거와 운영자 확인 항목을 분리합니다.",
    agentName: "EvidenceFusionAgent",
    stepType: "evidence_fusion",
  },
  {
    key: "research",
    label: "Research",
...
export function normalizeWorkflowResult(raw: unknown): WorkflowResult {
  ...
  return {
    ...
    evidence_profile: recordOrEmpty(result.evidence_profile),
    productization_advice: recordOrEmpty(result.productization_advice),
    data_coverage: recordOrEmpty(result.data_coverage),
    unresolved_gaps: arrayOrEmpty<Record<string, unknown>>(result.unresolved_gaps),
    source_confidence: typeof result.source_confidence === "number" ? result.source_confidence : 0,
    ui_highlights: arrayOrEmpty<Record<string, unknown>>(result.ui_highlights),

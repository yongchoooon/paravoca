# TourAPI KorService2 v4.4 API 명세 정리
...
|---|---|---|
| 한국관광공사 지역별 관광 자원 수요 API | 지역별 관광 서비스/문화 자원 수요 신호. `한국관광공사_국문 관광정보 서비스_GW`가 아니라 별도 수요지수/수요 신호 API | KorService2에는 미포함. 별도 `99_13_KTO_REGIONAL_TOURISM_DEMAND_SPEC.md`에 정리 |

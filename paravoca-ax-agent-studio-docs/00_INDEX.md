...
14. [14_POST_PHASE7_IMPLEMENTATION_PLAN.md](./14_POST_PHASE7_IMPLEMENTATION_PLAN.md)
    - Phase 7 이후 KTO 데이터 보강, AppShell 전역 navigation, Agent 실제화, 평가, 배포, Poster Studio 구현 순서
...
19. [19_PHASE_11_5_PLANNER_RESEARCH_LLM_CLEANUP.md](./19_PHASE_11_5_PLANNER_RESEARCH_LLM_CLEANUP.md)
   - Gemini PlannerAgent/ResearchSynthesisAgent 전환, EvidenceFusion card 보존, deterministic data_summary LLM Calls 분리, ApiCapabilityRouter와 future BaselineSearchPlanner 역할 구분

20. [20_PHASE_12_0_RETRIEVAL_STABILITY.md](./20_PHASE_12_0_RETRIEVAL_STABILITY.md)
   - Chroma metadata filter 안정화, empty result UX, GeoResolver catalog selection, 좁은 지역 keyword filter, DataGapProfiler 출력 상한

21. [21_PHASE_12_1_VISUAL_APIS.md](./21_PHASE_12_1_VISUAL_APIS.md)
   - 관광사진/관광공모전 사진 provider/executor 연결, 이미지 후보 저장, 사용권 확인 필요 상태, EvidenceFusion/Product UI 반영

22. [22_PHASE_12_2_ROUTE_SIGNAL_APIS.md](./22_PHASE_12_2_ROUTE_SIGNAL_APIS.md)
   - 두루누비/연관 관광지/관광빅데이터/혼잡 예측/지역 관광수요 provider/executor 연결, route asset/signal record/source document 저장, 보조 근거 claim 제한

23. [23_PHASE_12_3_THEME_APIS.md](./23_PHASE_12_3_THEME_APIS.md)
   - 웰니스/반려동물/오디오/의료관광 provider/executor 연결, theme candidate/source document 저장, 테마 근거 claim 제한

24. [24_PHASE_13_EVALUATION_DASHBOARD.md](./24_PHASE_13_EVALUATION_DASHBOARD.md)
   - Evaluation dataset/runner, 운영 진단 metric, evaluation API, AppShell Evaluation Dashboard

25. [25_NORTH_STAR_METRIC.md](./25_NORTH_STAR_METRIC.md)
   - 배포 후 실제 사용자 행동 기반 North Star Metric, 입력 지표, 이벤트 수집 기준, 공모전 발표용 해석
...
29. [29_PHASE_17_RAG_EVIDENCE_PIPELINE_HARDENING.md](./29_PHASE_17_RAG_EVIDENCE_PIPELINE_HARDENING.md)
   - Phase 17 RAG/Evidence pipeline hardening, source role/origin metadata, no-fallback retrieval, revision source stability 정리

30. [30_PHASE_18_EVIDENCE_UX_REDESIGN.md](./30_PHASE_18_EVIDENCE_UX_REDESIGN.md)
   - Phase 18 Evidence UX redesign 구현 결과, 사용자용 근거 표시 모델, raw metadata/신뢰도 수치 Developer 분리 정책 정리

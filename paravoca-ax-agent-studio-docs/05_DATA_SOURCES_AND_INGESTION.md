...
- [05_01_KTO_OPENAPI_DATA_ENRICHMENT_PLAN.md](./05_01_KTO_OPENAPI_DATA_ENRICHMENT_PLAN.md): 관광사진, 웰니스, 의료, 반려동물, 두루누비, 오디오 가이드, 관광빅데이터, 집중률 예측, 연관 관광지 데이터의 활용 계획
...
| 기능 | 목적 | 내부 tool name |
|---|---|---|
| 지역코드 조회 | TourAPI `areaCode` 응답 해석 | `tourapi_area_code` |
...
- `areaCode2`는 TourAPI 응답 해석에 사용합니다.
